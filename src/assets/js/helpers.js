export default {
  //generating random strings for unique room url
  ...
  //for generating qstring for storing unicode strings
  ...
  //geting audio and video from user and filtering it
  getUserFullMedia() {
